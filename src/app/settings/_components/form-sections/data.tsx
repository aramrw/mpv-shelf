...
export default function DataSection({
  ...
  return (
    <li className="flex h-fit flex-col justify-center rounded-b-sm bg-muted outline outline-zinc-200">
      <h1 className="select-none rounded-b-sm bg-accent p-1 font-bold">
        Data
      </h1>
